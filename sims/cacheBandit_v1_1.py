...
class bandit:
    ...
    def print_stats (self):
        ...
        return total_access, self.ext_hit, self.int_hit, avg_page_util, peak_page_util, self.cycle
    ...
    def find_L1 (self, set_sel, key):
        ...
        if (found == 0):
            if (vld):
                ...
                alloc = 1
                ptr, page, invld_set, invld_line, invld_vld = self.allocate(set_sel, at)
            life = life_MAX
            vld = 1
...
def main():
    ...
    log_path = '.\\logs\\'
    run_name = 'cb_test'
    log_run_name = run_name + '_' + str(worker_count) + '_' + str(contexts) + '_' + version
    #log_run_name = 'dummy' + '_' + str(worker_count) + '_' + str(contexts) + '_' + version
    ...
    Individual run
    """
    #mat_name = ['KM_4000_d100', 'KM_5000_d100']
    #dyn_sets = [vsets, vsets]
    ...
    for mid, mname in enumerate(mat_name):
        ...
        with open(log_name, 'w') as f:
            with redirect_stdout(f):
                ...
                compare_test(strmA_fname, shmem_line, shmem_assoc, dyn_sets[mid], page_size, pages, ipc)
